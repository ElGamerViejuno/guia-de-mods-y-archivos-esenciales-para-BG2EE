...
**[EE Fixpack](https://github.com/Gibberlings3/EE_Fixpack)** Se trata de **un parche todavía experimental** con una larga [lista de arreglos](https://www.gibberlings3.net/mods/fixes/eefp/) para todas las "Enhanced Editions" de Beamdog, osea BGEE, BG2EE, IWDEE y PsTEE. Puedes descargarlo en este enlace de [aquí](https://drive.google.com/file/d/1qscsc2kr0aFul2W0eBcf9kbzCUGMM8DM), ya que en su página oficial de GitHub, aparte de que todavía no hay ningún release oficial, puede ser complicado hacerlo funcionar con los archivos allí disponibles. Instala únicamente el componente "Core Fixes" y siempre después de instalar el DLC Merger y los packs de voces. ATENCIÓN; Se han encontrado varios componentes del mod Ascension incompatibles con este fixpack.
