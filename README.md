...
**[EE Fixpack](https://github.com/Gibberlings3/EE_Fixpack)** Se trata de un parche todavía en versión "alpha", pero con una larga [lista de arreglos](https://www.gibberlings3.net/mods/fixes/eefp/) para todas las "Enhanced Editions" de Beamdog, osea BGEE, BG2EE, IWDEE y PsTEE. Instala únicamente el componente "Core Fixes".
...
Lo que si que siempre va ser **MUY IMPORTANTE** es el orden de instalación de los mods. En la guía de Reddit anterior lo explican bastante bien, pero para despejar más las dudas puedes mirar esta web de [Baldurs-Gate-Install-Order-List-Repository](https://github.com/morpheus562/Baldurs-Gate-Install-Order-List-Repository) donde podrás ver directamente los **Weidu.log** con el orden de instalación de gente bastante experta. Conociendo estas listas te puedes asegurar de que tu instalación sea lo más perfecta posible. También aparte os voy a dejar un enlace donde podéis ver el **Weidu.log** de mi instalación actual [aquí](https://pastebin.com/K1PmfiTF).
...
**[Call of the Lost Goddess](https://github.com/AciferBG/Call-of-the-Lost-Goddess)** Simplemente uno de los mods más alucinantes de los últimos tiempos. Tan bueno que parece realizado por la antigua Bioware.
...
**[Banter Packs](https://github.com/Pocket-Plane-Group/Banter_Pack)** Añade nuevos dialogos para diferentes personajes en BG2.

**[Bolsa](https://github.com/SpellholdStudios/Bolsa)** Añade un comerciante que vende varios contenedores, bolsas, cinturón de municiones, etcétera para no tener tantos objetos ocupando espacio en tu inventario.

**[Rogue Rebalancing](https://drive.google.com/file/d/1kdxhPp908Jb73Y2KFccmErjnIA95Xo1H)** Diseñado para bardos y ladrones para que sus respectivos kits sean más cercanos al D&D de lápiz y papel. También añade objetos y algún encuentro. Funciona tanto para BGEE como BG2EE.

**[Portraits Portraits Everywhere](https://github.com/DaftHunk/Portraits-Portraits-Everywhere)** Añade mucha más inmersión en tus partidas con cientos y cientos de retratos elegidos meticulosamente en gran parte de los NPC's con los que te vas a encontrar, tanto en BGEE como en BG2EE. Descargarlo en GitHub puede ser confuso al no aparecer nada en "releases". Haz click en "Code" (un botón de color verde) y luego al desplegarse una ventanita dale a "Download ZIP", el archivo se llama "Portraits-Portraits-Everywhere-master.zip" y debería incluir un ejecutable.
