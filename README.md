# GUÍA DE MODS Y ARCHIVOS ESENCIALES PARA BALDUR'S GATE 2 EN ESPAÑOL
...
Existe cierta confusión por parte de muchos jugadores hispanohablantes con las diferentes versiones del juego que llegaron a disfrutar en el pasado. Incluso algunos jugadores ni siquiera recuerdan que el juego tuviera voces en español.

Veamos con detalle los lanzamientos de esta secuela cronológicamente:

**Baldur's Gate II: Shadows of Amn (2000, Bioware)** El lanzamiento de esta secuela llegó completamente traducido y con voces al español. Por supuesto, tampoco se puede asegurar que fuera al 100% ya que con tanto contenido siempre pudo haberse escapado algún detalle sin doblaje o traducido en nuestro idioma.

**Baldur's Gate II: Throne of Bhaal (2001, Bioware)** La única expansión oficial de BG2, que también llegó completamente traducida y con voces al español.
...
**Baldur's Gate II: Enhanced Edition (2013, Beamdog)** Incluye la expansión "Throne of Bhaal" junto al juego base con la traducción mejorada de ClanDlan. Aparte también se añade un nuevo contenido creado por Beamdog con nuevos NPC's que se pueden unir a tu grupo, sus respectivas misiones y una pequeña aventura paralela llamada "The Black Pits II: Gladiators of Thay". ClanDlan se encargo de traducir los nuevos textos al completo, pero todo este nuevo contenido nunca tuvo voces en español. Es importante señalar que en esta "Enhanced Edition" tienes todos los textos traducidos al español, pero nunca añadieron el antiguo doblaje en español. 

*(Por supuesto, puedes poner las voces del juego en español si instalas por tu cuenta un pack con las voces de la versión antigua del juego, pero lógicamente por todo lo anteriormente comentado no son completas al 100%)*

## Archivos importantes
**[Pack de voces en español para BG2EE](https://drive.google.com/file/d/13hzXALeh1rtgGLH6DP97FLjoJsi22Rvt)** Este pack de voces en español parece funcionar bien en la última version 2.6.6.0 del juego. Los archivos tienen que descomprimirse donde tengas instalado el juego, exactamente en "\lang\es_ES". Recordad que el doblaje en nuestro idioma no es completo al 100% por las razones anteriormente comentadas y de vez en cuando pueden encontrarse algunas voces en inglés.

## Introducción a los mods
Quizás muchos jugadores piensen que no vale la pena o les pueda dar pereza aprender y ponerse a meterle mods a este juego, pero es que algunos de estos mods llevan más de 20 años con innumerables actualizaciones por gente bastante experta de la comunidad internacional, incluso a veces estan involucrados antiguos desarrolladores que participaron en la creación de la saga Baldur's Gate. Muchos de estos mods se consideran al mismo nivel de calidad o incluso llegan a mejorar el contenido original.

Demos por hecho que ya tienes algunos conocimientos sobre instalación de mods en juegos con el motor Infinity Engine (Baldur's Gate, Icewind Dale, Planescape Torment), si no es así te recomiendo que le heches un vistazo a esta [url=https://www.reddit.com/r/baldursgate/comments/plkft5/a_new_players_guide_to_installing_and_playing_mods/]guía de Reddit para instalar mods[/url]. De todos modos no tiene demasiada complicación, son los típicos mods que solamente tienes que descomprimir los archivos en la carpeta exacta con la instalación del juego para luego activar un ejecutable.
...
[url=https://github.com/InfinityMods/Ascension][b]Ascension[/b][/url] Una recopilación de cambios en Throne of Bhaal, que busca proporcionar una historia más rica y una jugabilidad más interesante desde el punto de vista táctico. Su componente principal reescribe por completo el final de Throne of Bhaal, agregando nuevos enemigos y nuevos aliados; otros componentes mejoran el desafío táctico de muchas de las batallas clave en Throne of Bhaal, mejoran los diálogos centrales de la trama y las habilidades de los jugadores, y más. El líder del proyecto fue David Gaider, uno de los escritores de Throne of Bhaal (y más tarde escritor principal de la serie Dragon Age).

[url=https://github.com/Argent77/A7-SkipChateauIrenicus][b]Skip Chateau Irenicus[/b][/url] Imprescindible para los que quieren saltarse rápido la primera mazmorra del juego. Esta basado en el conocido mod "Dungeon-Be-Gone", pero  mucho más trabajado y especialmente respetuoso con el lore, al contrario que su antecesor. Con este mod ya el antiguo "Dungeon-Be-Gone" se considera completamente obsoleto.

[url=https://github.com/Pocket-Plane-Group/UnfinishedBusiness][b]Unfinished Business (BG2)[/b][/url] Diseñado para restaurar muchos de los elementos cortados, misiones, diálogos y encuentros en el lanzamiento final del juego, así como para intentar atar algunos "cabos sueltos".

[url=https://github.com/SpellholdStudios/Almaterias_Restoration_Project][b]Almateria's Restoration Project[/b][/url] Diseñado para restaurar literalmente todos los sonidos no utilizados, así como algunos personajes o ubicaciones de corte menor.

[url=https://www.pocketplane.net/quest-pack/][b]Quest Pack[/b][/url] Añade una serie de aventuras adicionales a lo largo de "Shadows of Amn" y "Throne of Bhaal".

[url=https://github.com/Pocket-Plane-Group/Assassinations][b]Assassinations[/b][/url] Añade diez misiones y varias subquests al juego. Solo para personajes malvados.

[url=https://github.com/Pocket-Plane-Group/Banter_Pack][b]Banter Packs[/b][/url] Añade nuevos dialogos para diferentes personajes en BG2.

[url=https://github.com/SpellholdStudios/Bolsa][b]Bolsa[/b][/url] Añade un comerciante que vende varios contenedores, bolsas, cinturón de municiones, etcétera para no tener tantos objetos ocupando espacio en tu inventario.
...
[url=https://github.com/DaftHunk/Portraits-Portraits-Everywhere][b]Portraits Portraits Everywhere[/b][/url] Añade mucha más inmersión en tus partidas con cientos y cientos de retratos elegidos meticulosamente en gran parte de los NPC's con los que te vas a encontrar, tanto en BGEE como en BG2EE. Descargarlo en GitHub puede ser confuso al no aparecer nada en "releases". Haz click en "Code" (un botón de color verde) y luego al desplegarse una ventanita dale a "Download ZIP", el archivo se llama "Portraits-Portraits-Everywhere-master.zip" y debería incluir un ejecutable.

[url=https://github.com/Gibberlings3/Tweaks-Anthology][b]The Tweaks Anthology[/b][/url]; Algunos truquillos y cambios cosméticos para instalar al gusto de cada uno. Funciona tanto para BGEE como BG2EE.

[url=https://github.com/Gibberlings3/SwordCoastStratagems][b]Sword Coast Stratagems[/b][/url] Imprescindible para muchos jugadores veteranos, ideal para los que buscan nuevos retos, con este mod se mejora la IA de los enemigos y la dificultad del juego. Funciona tanto para BGEE como BG2EE. También puedes disponer de una versión no oficial del mod con español incluido [url=https://drive.google.com/file/d/1gH42XMYh0OeT5tntX3SQkAUVy0cZ1AN-]aquí[/url].

[url=https://github.com/Bubb13/EEex][b]EEex[/b][/url] Aumenta las posibilidades de modding en las versiones "Enhanced Edition". Por si solo este mod no realiza cambios, simplemente permite que otros mods puedan funcionar. Su instalador ofrece componentes adicionales que considero grandes mejoras, como poder ver los hechizos que afectan a las criaturas y también unas barras de colores que aparecen a la izquierda de los retratos de tus personajes que van indicando los tiempos para el lanzamiento de hechizos, uso de objetos o habilidades.

[url=https://github.com/tapahob/BG2RadarOverlay][b]BG2RadarOverlay[/b][/url] Añade la posibilidad de abrir una ventana ingame pulsando un botón que muestra todas las estadísticas del enemigo señalado. Podrás ver resistencias, buffos, debuffos y el tiempo de duración restante de estos. Así puedes actuar con más conocimiento durante los combates y ver puntos débiles del enemigo. Funciona tanto para BGEE como BG2EE. Necesita EEex para funcionar.

[url=https://github.com/Bubb13/Bubbs-Spell-Menu-Extended][b]Bubbs-Spell-Menu-Extended[/b][/url] Te muestra una lista de hechizos en medio de la pantalla de un modo ordenado por niveles, para no perder mucho tiempo buscando el hechizo a lanzar. Recuerda que cuando tienes muchos hechizos disponibles es fácil perderse en la barra del interface original. Funciona tanto para BGEE como BG2EE. Necesita EEex para funcionar.
...
Por cierto, también he creado otra guía similar sobre el primer Baldur's Gate: Enhanced Edition
